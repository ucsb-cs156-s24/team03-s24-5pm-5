...
describe("UCSBOrganizationCreatePage tests", () => {
    ...
    test("on submit, makes request to backend, and redirects to /ucsborganization", async () => {
        ...
        fireEvent.change(orgCodeInput, { target: {value: 'abc'} })
        fireEvent.change(orgTranslationShortInput, { target: { value: 'UCSB' } })
        fireEvent.change(orgTranslationInput, { target: { value: 'University of California, Santa Barbara' } })
        ...
        expect(mockToast).toBeCalledWith("New UCSB Organization Created - orgCode: abc");
