...
describe("MenuItemReviewIndexPage tests", () => {
    ...
    test("renders three menuitemreviews correctly for regular user", async () => {
        ...
        const comments = screen.getByText("kinda good");
        expect(comments).toBeInTheDocument();

        const reviewerEmail = screen.getByText("abc@gmail.com");
    ...
    test("what happens when you click delete, admin", async () => {
        ...
        axiosMock.onGet("/api/menuitemreview/all").reply(200, menuItemReviewFixtures.threeMenuItemReviews);
        axiosMock.onDelete("/api/menuitemreview").reply(200, "Menu Item Review with id 1 was deleted");
        ...
        await waitFor(() => { expect(mockToast).toBeCalledWith("Menu Item Review with id 1 was deleted") });
