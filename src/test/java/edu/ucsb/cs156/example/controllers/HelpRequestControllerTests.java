...
public class HelpRequestControllerTests extends ControllerTestCase {
    ...
    public void test_that_logged_in_user_can_get_by_id_when_the_id_exists()
        ...
        when(helpRequestRepository.findById(eq(7L))).thenReturn(Optional.of(
            helpRequest));
    ...
    public void admin_can_delete_a_helprequest() throws Exception {
        ...
        when(helpRequestRepository.findById(eq(15L))).thenReturn(Optional
            .of(helpRequest1));
    ...
    public void admin_can_edit_an_existing_helprequest() throws Exception {
        ...
        HelpRequest helpRequestEdited = HelpRequest.builder()
            .requesterEmail("testt")
            .teamId("teamIdentifiert")
            .tableOrBreakoutRoom("tablet")
            .requestTime(ldt2)
            .explanation("somethingt")
            .solved(false)
            .build();

        String requestBody = mapper.writeValueAsString(helpRequestEdited);

        when(helpRequestRepository.findById(eq(67L))).thenReturn(Optional
            .of(helpRequestOrig));
        ...
        verify(helpRequestRepository, times(1)).save(helpRequestEdited); // should
                                                                            // be
                                                                            // saved
                                                                            // with
                                                                            // correct
