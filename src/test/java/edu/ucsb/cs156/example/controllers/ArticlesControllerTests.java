...
public class ArticlesControllerTests extends ControllerTestCase{
    ...
    public void an_admin_user_can_post_a_new_article() throws Exception {
            ...
            Articles article1 = Articles.builder()
                            .title("test1post")
                            .url("test1post.com")
                            .explanation("test2post explanation")
                            .email("test2post@gmail.com")
                            .dateAdded(ldt1)
                            .build();
    ...
    public void admin_can_edit_an_existing_article() throws Exception {
            ...
            Articles articleEdited = Articles.builder()
                                .title("test1postEDITED")
                                .url("test1post.comEDITED")
                                .explanation("test2post explanationEDITED")
                                .email("test2post@gmail.comEDITED")
                                .dateAdded(ldt2)
                                .build();
    ...
    public void admin_cannot_edit_article_that_does_not_exist() throws Exception {
            ...
            Articles ucsbEditedDate = Articles.builder()
                                    .title("test1post")
                                    .url("test1post.com")
                                    .explanation("test2post explanation")
                                    .email("test2post@gmail.com")
